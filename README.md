...
- Download the debian package for your architecture (placeholder URLs; update them):
...
- Download the DMG:
  - [Apple Silicon lirays-scada-0.1.0-arm64.dmg](https://github.com/LiRAYSgj/LiRAYS-Scada/releases/download/v0.1.0/lirays-scada-0.1.0-arm64.dmg)
  - [Apple Silicon lirays-scada-0.1.0-arm64.pkg](https://github.com/LiRAYSgj/LiRAYS-Scada/releases/download/v0.1.0/lirays-scada-0.1.0-arm64.pkg)
  - Intel: Not available yet
- Open the `.dmg` (or download pkg directly) and run the `.pkg`, or via CLI:
