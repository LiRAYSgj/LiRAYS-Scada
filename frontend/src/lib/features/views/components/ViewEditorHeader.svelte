...
<header class="flex items-center justify-between border-b border-border px-4 py-2.5">
  ...
  <div class="flex items-center gap-1">
    <Button
      ...
      ariaLabel="Send selected widgets to back"
      disabled={!canOrderSelection}
      onclick={onSendSelectionToBack}
    />
    <Button
      variant="icon"
      icon={ArrowDown}
      title="Send selected widgets backward"
      ariaLabel="Send selected widgets backward"
      disabled={!canOrderSelection}
    ...
    <Button
      variant="icon"
      icon={ArrowUp}
      title="Bring selected widgets forward"
      ariaLabel="Bring selected widgets forward"
      disabled={!canOrderSelection}
      onclick={onBringSelectionForward}
    />
    <Button
      variant="icon"
      icon={BringToFront}
      title="Bring selected widgets to front"
      ariaLabel="Bring selected widgets to front"
      disabled={!canOrderSelection}
