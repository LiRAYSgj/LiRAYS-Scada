...
export const FolderChanged: MessageFns<FolderChanged> = {
  ...
  create<I extends Exact<DeepPartial<FolderChanged>, I>>(
    base?: I,
  ): FolderChanged {
    return FolderChanged.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<FolderChanged>, I>>(
    object: I,
  ): FolderChanged {
    const message = createBaseFolderChanged();
    ...
    message.newFolders =
      object.newFolders?.map((e) => FolderInfo.fromPartial(e)) || [];
    message.newVariables =
      object.newVariables?.map((e) => VarInfo.fromPartial(e)) || [];
    return message;
  },
};
...
export const TreeChanged: MessageFns<TreeChanged> = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1: {
          ...
          message.folderChangedEvent.push(
            FolderChanged.decode(reader, reader.uint32()),
          );
          continue;
        }
      }
    ...
    return {
      folderChangedEvent: globalThis.Array.isArray(object?.folderChangedEvent)
        ...
        : globalThis.Array.isArray(object?.folder_changed_event)
          ? object.folder_changed_event.map((e: any) =>
              FolderChanged.fromJSON(e),
            )
          : [],
    };
  },
  ...
  toJSON(message: TreeChanged): unknown {
    ...
    if (message.folderChangedEvent?.length) {
      obj.folderChangedEvent = message.folderChangedEvent.map((e) =>
        FolderChanged.toJSON(e),
      );
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<TreeChanged>, I>>(
    object: I,
  ): TreeChanged {
    const message = createBaseTreeChanged();
    message.folderChangedEvent =
      object.folderChangedEvent?.map((e) => FolderChanged.fromPartial(e)) || [];
    return message;
  },
};
...
export const Event: MessageFns<Event> = {
  ...
  fromPartial<I extends Exact<DeepPartial<Event>, I>>(object: I): Event {
    const message = createBaseEvent();
    message.varValueEv =
      object.varValueEv !== undefined && object.varValueEv !== null
        ? VarIdValue.fromPartial(object.varValueEv)
        : undefined;
    message.treeChangedEv =
      object.treeChangedEv !== undefined && object.treeChangedEv !== null
