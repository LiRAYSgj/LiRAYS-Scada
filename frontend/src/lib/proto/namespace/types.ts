...
export interface UnifiedNamespaceSchema {
  roots: { [key: string]: NamespaceNode };
}

export interface UnifiedNamespaceSchema_RootsEntry {
  key: string;
...
function createBaseUnifiedNamespaceSchema(): UnifiedNamespaceSchema {
  return { roots: {} };
}
...
export const UnifiedNamespaceSchema: MessageFns<UnifiedNamespaceSchema> = {
  ...
  fromJSON(object: any): UnifiedNamespaceSchema {
    return {
...
function createBaseUnifiedNamespaceSchema_RootsEntry(): UnifiedNamespaceSchema_RootsEntry {
  return { key: "", value: undefined };
}
