...
class Command(_message.Message):
    ...
    set: SetCommand
    get: GetCommand
    def __init__(self, add: _Optional[_Union[AddCommand, _Mapping]] = ..., list: _Optional[_Union[ListCommand, _Mapping]] = ..., set: _Optional[_Union[SetCommand, _Mapping]] = ..., get: _Optional[_Union[GetCommand, _Mapping]] = ..., **kwargs) -> None: ...

class Response(_message.Message):
    __slots__ = ("add", "list", "set", "get", "inv", "status", "error_msg")
    ADD_FIELD_NUMBER: _ClassVar[int]
    LIST_FIELD_NUMBER: _ClassVar[int]
    SET_FIELD_NUMBER: _ClassVar[int]
    GET_FIELD_NUMBER: _ClassVar[int]
