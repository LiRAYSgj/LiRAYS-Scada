use winnow::{ascii::dec_uint, combinator::opt, error::ContextError, Parser};
...
mod tests {
    ...
    fn test_parse_repeated_name() {
        ...
        assert_eq!((pfx, sfx, s, e, stp, opts), ("flat-string".into(), "".into(), None, None, None, None));

        let (pfx, sfx, s, e, stp, opts) = parse_repeated_name("some-string[:10]");
        assert_eq!((pfx + &sfx, s, e, stp, opts), ("some-string".into(), None, Some(10), None, None));

        let (pfx, sfx, s, e, stp, opts) = parse_repeated_name("some-string[24:10]");
        assert_eq!((pfx + &sfx, s, e, stp, opts), ("some-string".into(), Some(24), Some(10), None, None));

        let (pfx, sfx, s, e, stp, opts) = parse_repeated_name("some-string[:10:2]");
        assert_eq!((pfx + &sfx, s, e, stp, opts), ("some-string".into(), None, Some(10), Some(2), None));

        let (pfx, sfx, s, e, stp, opts) = parse_repeated_name("some-string[2:10:2]");
        assert_eq!((pfx + &sfx, s, e, stp, opts), ("some-string".into(), Some(2), Some(10), Some(2), None));

        let (pfx, sfx, s, e, stp, opts) = parse_repeated_name("some-string[2:]");
        assert_eq!((pfx + &sfx, s, e, stp, opts), ("some-string".into(), Some(2), None, None, None));

        let (pfx, sfx, s, e, stp, opts) = parse_repeated_name("some-string[2::3]");
        assert_eq!((pfx + &sfx, s, e, stp, opts), ("some-string".into(), Some(2), None, Some(3), None));

        let (pfx, sfx, s, e, stp, opts) = parse_repeated_name("some-string[:]");
        assert_eq!((pfx + &sfx, s, e, stp, opts), ("some-string".into(), None, None, None, None));

        let (pfx, sfx, s, e, stp, opts) = parse_repeated_name("some-string[::]");
        assert_eq!((pfx + &sfx, s, e, stp, opts), ("some-string".into(), None, None, None, None));

        let (pfx, sfx, s, e, stp, opts) = parse_repeated_name("some-string[10]");
        assert_eq!((pfx + &sfx, s, e, stp, opts), ("some-string[10]".into(), None, None, None, None));

        let (pfx, sfx, s, e, stp, opts) = parse_repeated_name("some-string[a:b]");
        assert_eq!((pfx + &sfx, s, e, stp, opts), ("some-string[a:b]".into(), None, None, None, None));

        let (pfx, sfx, s, e, stp, opts) = parse_repeated_name("some-string[10:5]");
        assert_eq!((pfx + &sfx, s, e, stp, opts), ("some-string".into(), Some(10), Some(5), None, None));

        let (pfx, sfx, s, e, stp, opts) = parse_repeated_name("some-string[10:15:10]");
        assert_eq!((pfx + &sfx, s, e, stp, opts), ("some-string".into(), Some(10), Some(15), Some(10), None));

        let (pfx, sfx, s, e, stp, opts) = parse_repeated_name("some-string[2::2]");
        assert_eq!((pfx + &sfx, s, e, stp, opts), ("some-string".into(), Some(2), None, Some(2), None));

        let (pfx, sfx, s, e, stp, opts) = parse_repeated_name("my_name[ab, xz, kk]");
        assert_eq!((pfx + &sfx, s, e, stp, opts), ("my_name".into(), None, None, None, Some(vec!["ab".into(), "xz".into(), "kk".into()])));

        let (pfx, sfx, s, e, stp, opts) = parse_repeated_name("name[1:3]tail");
        assert_eq!((pfx, sfx, s, e, stp, opts), ("name".into(), "tail".into(), Some(1), Some(3), None, None));

        let (pfx, sfx, s, e, stp, opts) = parse_repeated_name("name[a,b]tail");
        assert_eq!((pfx, sfx, s, e, stp, opts), ("name".into(), "tail".into(), None, None, None, Some(vec!["a".into(), "b".into()])));
    }
    ...
    fn test_clone_name() {
        ...
        assert_eq!(names, vec!["prefix1suffix", "prefix2suffix", "prefix3suffix", "prefix4suffix"]);
