...
help:
	@echo "Targets:"
	@echo "  make           -> build deb and rpm (amd64+arm64 using Docker)"
...
deb-amd64: prepare-dist frontend
...
deb-arm64: prepare-dist frontend
...
rpm-amd64: prepare-dist frontend
...
rpm-arm64: prepare-dist frontend
...
mac:
	@echo "Not supported yet (macOS build placeholder)"
